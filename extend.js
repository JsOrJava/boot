...
extend = function(superClass,config){
	...
	helper.apply(f.prototype,config);
	//console.info(new f().name,"  ",superClass.prototype.name);
	//console.info('aa ',f.prototype.name,'  ',superClass.prototype.name);
	//console.info('abc ',f.prototype);
	//console.info('aaaaaaaaaaa ',f.abc);
	return f;
